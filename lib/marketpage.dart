...
class Mkt1Home extends StatefulWidget {
  @override
  _Mkt1HomeState createState() => _Mkt1HomeState();
}

class _Mkt1HomeState extends State<Mkt1Home> {
          ...
          slivers: <Widget>[
            ...
            SliverList(
              delegate: SliverChildListDelegate(
                <Widget>[
                  myCardDetails(
                      "images/bitcoin.png", "Wheat", data1, "4702", "3.0", "\u2191", 0xff07862b),
                  myCardDetails(
                      "images/bitshares.png", "Barley", data2, "3802", "4.0", "\u2193", 0xffff0000),
                  myCardDetails(
                      "images/ethereum.png", "Corn", data3, "7702", "5.0", "\u2191", 0xff07862b),
                  myCardDetails(
                      "images/counterparty.png", "Rye", data7, "4702", "3.0", "\u2193", 0xffff0000),

                  myCardDetails(
                      "images/lykke.png", "Rice", data5, "8600", "2.0", "\u2191", 0xff07862b),
                  myCardDetails(
                      "images/peercoin.png", "Pulses", data6, "4702", "2.5", "\u2191", 0xff07862b),
                  myCardDetails(
                      "images/zcash.png", "Millet", data4, "2345", "2.0", "\u2193", 0xffff0000),
                  myCardDetails(
                      "images/singular.png", "Oatmeal", data8, "3800", "2.5", "\u2191", 0xffff0000),
                  myCardDetails(
                      "images/litecoin.png", "Brown Wheat", data9, "2000", "3.0", "\u2193", 0xffff0000),
